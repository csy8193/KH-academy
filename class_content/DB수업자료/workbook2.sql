...
--    빠른 순으로 표시하는 SQL 문장을 작성하시오.( 단, 헤더는 "학번", "이름",
--    "입학년도"가 표시되도록 한다.)
...
FROM TB_PROFESSOR WHERE PROFESSOR_NAME NOT LIKE '___';
...
--    월 몇 일을 의미할까? 또 TO_DATE('99/10/11', 'RR/MM/DD'), TO_DATE('49/10/11', 'RR/MM/DD')
...
-- 8. 춘 기술디학교의 2000년도 이후 입학자들은 학번이 A로 시작하게 되어있다. 2000년도
...
--    이때 출력 화면은 헤더는 "평점" 이라고 찍히게 하고, 점수는 반올림하여 소수점 이하 한자리
--    까지만 표시한다.
...
--     SQL문을 작성하시오. (단, 평점은 소수점 1 자리까지만 반올림하여 표시한다.)
