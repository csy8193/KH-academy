...
SELECT DEPARTMENT_NAME AS "학과 명", CATEGORY AS "학과 명" FROM TB_DEPARTMENT;
...
SELECT STUDENT_NO FROM TB_DEPARTMENT WHERE DEPARTMENT_NO IS NULL;
...
AND ABSENCE_YN = 'N'
AND TO_CHAR(ENTRANCE_DATE, 'YY') = '02'; -- EXTRACT(YEAR FROM ENTRANCE_DATE) = 2002
